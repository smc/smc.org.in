      ...
      <section id="header" class="row">
        <v-sheet class="col-12">
          ...
          >
            ...
            <v-carousel-item>
              <v-card
                class="rachana-slide-1 py-auto fill-height"
                height="100%"
                align="center"
                color="tranparent"
              >
                <p class="pa-4 ma-4">
                  Rachana is a Malayalam font designed by Hussain K. H.
                </p>
              </v-card>
            </v-carousel-item>
            <v-carousel-item>
              ...
              >
                <article>
                  <h2>നാടൊന്നാകെ നാടകത്തെ ഏറ്റെടുക്കുമ്പോള്‍</h2>
                  <p>
