<template>
  <v-container class="dyuthi v-col-xl-8 v-col-sm-10 v-col-xs-12">
    <main id="dyuthi">
      <font-title
        :name="$i18n('dyuthi')"
      ...
      >
        <v-sheet class="v-col-12">
          ...
          >
            ...
            <v-carousel-item>
              <v-card
                class="dyuthi-slide-1 py-auto fill-height"
                height="100%"
                align="center"
                color="tranparent"
              >
                <p class="pa-4 ma-4">
                  Dyuthi is an ornamental typographic design that supports Latin
        ...
        <div class="v-col-lg-8 v-col-md-12">
          <ul>
            <li class="my-4 font-weight-bold">
              TTF Format:
              <v-btn href="/downloads/fonts/dyuthi/Dyuthi-Regular.ttf">
                {{ $i18n("regular") }}
              </v-btn>
            </li>
            <li class="my-4 font-weight-bold">
              ...
              <v-btn href="/downloads/fonts/dyuthi/Dyuthi-Regular.woff2">
                {{ $i18n("regular") }}
              </v-btn>
            </li>
            <li class="my-4 font-weight-bold">
              All files in compressed zip file:
              <v-btn href="/downloads/fonts/dyuthi/dyuthi.zip">
                {{ $i18n("zip") }}
              </v-btn>
            </li>
          </ul>
      ...
      >
        ...
        />
        <p class="v-col-lg-8 v-col-md-12">
          Dyuthi typefaces's source code, including svg drawings, build scripts
          are available at
          <a href="https://gitlab.com/smc/fonts/dyuthi">gitlab repository</a>
        </p>
      </section>
      <section
        id="playground"
      ...
      >
        ...
        <div class="v-col-lg-8 v-col-md-12">
          <h4 id="contribute">
            Can I help with improving Dyuthi?
          </h4>
          <p>
            Yes you can! Dyuthi is an open-source project, meaning the source
