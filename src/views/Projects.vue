    ...
    <div class="projects">
      ...
      <section class="row">
        <v-card outlined height="400px" class="col-lg-5 col-md-12 ma-4" hover>
          <v-img height="200px" contain src="@/assets/images/indickeyboard.png">
          </v-img>

          <v-card-title>Indic Keyboard</v-card-title>
        ...
        <v-card outlined height="400px" class="col-lg-5 col-md-12 ma-4" hover>
          ...
          <v-card-text class="text--primary flex-grow-1">
            ...
            across different platforms in almost all indic languages.
          </v-card-text>
        ...
        <v-card outlined height="400px" class="col-lg-5 col-md-12 ma-4" hover>
          ...
          <v-card-text class="text--primary flex-grow-1">
            Libindic is a web platform to host Free Software language processing
            applications. It consists of a web framework and a set of
            applications for processing Indian languages. It is a platform for
            porting existing and upcoming language processing applications to
            the web.
          </v-card-text>
        ...
        <v-card outlined height="400px" class="col-lg-5 col-md-12 ma-4" hover>
          ...
          <v-card-text class="text--primary flex-grow-1">
            Dhvani is a text to speech system designed for Indian Languages. It
            is helpful for the visually challenged users as a screenreader in
            their mother tongue. Currently dhvani is capable of generating
        ...
        <v-card outlined height="400px" class="col-lg-5 col-md-12 ma-4" hover>
          ...
          <v-card-text class="text--primary flex-grow-1">
            ...
            approach of braille. It currently supports seven languages English,
            Malayalam, Hindi, Kannada, Tamil, French, and Spanish.
          </v-card-text>
        ...
        <v-card outlined height="400px" class="col-lg-5 col-md-12 ma-4" hover>
          ...
          <v-card-text class="text--primary flex-grow-1">
            ...
            datapool. It suppports all indian languages and have interfaces and
            apis fo library, publishers and general public. The Malayalagrandham
            dataset the biggest bibliography data set in malayalam and may be
            the largest malayalam Open data archive.
          </v-card-text>
