<template>
  <v-container class="col-xl-8 col-sm-10 col-xs-12">
    <h1 class="display-3 my-4" v-i18n="'menu-research'"></h1>
    <article>
      <section id="papers" class="my-4">
        <h2>Published papers</h2>
        <section class="row">
          <v-card class="col-lg-5 col-md-12 ma-2">
            <v-card-title>
          ...
          <v-card class="col-lg-5 col-md-12 ma-2">
            ...
            <v-card-text>
              ...
              Pôle numérique Brest Iroise at Brest, France, on June 14-15, 2018.
            </v-card-text>
            <v-card-actions class="justify-end">
              <v-btn
                text
      ...
      <section id="studies" class="my-4">
        ...
        <section class="row">
          ...
          <v-card class="col-lg-5 col-md-12 ma-2">
            <v-card-title
              >A finite state Transducer based approach for Malayalam phonetics
