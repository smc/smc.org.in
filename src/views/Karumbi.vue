<template>
  <v-container class="karumbi v-col-xl-8 v-col-sm-10 v-col-xs-12">
    <main id="karumbi">
      <font-title
        :name="$i18n('karumbi')"
        ...
        <v-sheet class="v-col-12">
          ...
          >
            ...
            <v-carousel-item>
              ...
              >
                <p class="pa-4 ma-4">
                  The Karumbi opentype font, is a Malayalam traditional script
                  font desinged by Kevinsiji. The characters are literally
                  written directly into a computer by Kevinsiji using a tablet
                  pen. Karumbi follows a casual style, suitable for handwritten
                  type text. It has Individually designed glyphs for complex
                  conjuncts rather than using component glyphs.
                </p>
              </v-card>
            </v-carousel-item>
            <v-carousel-item>
        ...
        <div class="v-col-lg-8 v-col-md-12">
          <ul>
            <li class="my-4 font-weight-bold">
              TTF Format:
              <v-btn href="/downloads/fonts/karumbi/Karumbi-Regular.ttf">
                {{ $i18n("regular") }}
              </v-btn>
            </li>
            <li class="my-4 font-weight-bold">
              ...
              <v-btn href="/downloads/fonts/karumbi/Karumbi-Regular.woff2">
                {{ $i18n("regular") }}
              </v-btn>
            </li>
            <li class="my-4 font-weight-bold">
              All files in compressed zip file:
              <v-btn href="/downloads/fonts/karumbi/karumbi.zip">
                {{ $i18n("zip") }}
              </v-btn>
            </li>
          </ul>
      ...
      >
        ...
        />
        <p class="v-col-lg-8 v-col-md-12">
          Karumbi typefaces's source code, including svg drawings, build scripts
          are available at
      ...
      >
        ...
        <div class="v-col-lg-8 v-col-md-12">
          <h4 id="contribute">
            Can I help with improving Karumbi?
          </h4>
          <p>
            Yes you can! Karumbi is an open-source project, meaning the source
