<template>
  <v-container class="keraleeyam v-col-xl-8 v-col-sm-10 v-col-xs-12">
    <main id="keraleeyam">
      <font-title
      ...
      >
        ...
        <p class="v-col-lg-8 v-col-md-12">
          ...
          <a href="https://gitlab.com/smc/fonts/keraleeyam">gitlab repository</a>
        </p>
      </section>
      <section
        id="playground"
      ...
      >
        ...
        <div class="v-col-lg-8 v-col-md-12">
          <h4 id="contribute">
            Can I help with improving Keraleeyam?
          </h4>
          <p>
